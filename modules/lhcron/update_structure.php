<?php 
/**
 * php cron.php -s site_admin -e lhcgooglesuggest -c cron/update_structure
 * */

$contentData = file_get_contents('extension/lhcgooglesuggest/doc/structure.json');
...
if (empty($queries)) {
    ...
    echo "The following queries will be executed\nYou have 10 seconds to stop executing these queries\n";
    echo implode("\n", $queries)."\n";
    sleep(10);
